...
private static void menuProgram() {
    ...
    while(loopX == 0) {
        ...
        System.out.println("2. Hapus antrian dari element pertama");
        System.out.println("3. Hapus antrian di posisi tertentu");
        System.out.println("4. Status antrian");
        System.out.println("5. Tampilkan data dalam Antrian");
        System.out.println("6. Hapus semua element");
